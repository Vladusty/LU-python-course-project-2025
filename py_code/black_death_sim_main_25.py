...
class City_SIRD:
    ...
    def __init__(self, population, initial_infected=0, beta=0.22, gamma=0.05, mu=0.02, name="City", cap_frac=0.08, overload_mult=1.0):
...
mediterranean_cities = [
    ...
    sarai, burgos, bordeaux, montpellier, toulouse
]
for c in mediterranean_cities:
    G.add_node(c)

bns_cities = [
    riga, vilnius, tallinn, berlin, brussels, danzig, ghent, turku, dublin, oslo,
...
G.add_edge(constantinople, genoa,        weight=1.5)
...
# === STORAGE FOR TIME SERIES === NODZEST
history = {
    "Feodosia": [],
    "Constantinople": [],
    "Paris": [],
...
plt.title("Dynamics of Infection — Feodosia, Constantinople, Paris, Riga")
plt.legend()
plt.grid(True)
plt.tight_layout()
plt.show()
